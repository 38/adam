...
#define CESK_VALUE_NUMBERIC_POSITIVE 1  /* if a numeric value is positive */
#define CESK_VALUE_NUMERIC_ZERO 0       /* if a numeric value is zero */
#define CESK_VALUE_NUMBERIC_NEGATIVE -1 /* if a numeric value is negative */
...
typedef struct _cesk_value_set_t {
