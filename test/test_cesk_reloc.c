...
int main()
{
	...
	uint32_t ra1 = cesk_reloc_allocate(reloc_tab, store1, ins, 0, 0, CESK_STORE_ADDR_NULL);
	...
	uint32_t _unused = cesk_store_allocate(store2, ins, 1, 0, CESK_STORE_ADDR_NULL);   /* just make the store allocate a new block */
