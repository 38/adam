...
bci_class_t addressContainer_metadata = {
	.size = sizeof(this_t),
	.load = addressContainer_onload,
	.initialize = addressContainer_init,
	.finalize = addressContainer_delete,
	.duplicate = addressContainer_dup,
	.read = addressContainer_get_addr_list,
	.write = addressContainer_modify,
	...
	.has_reloc_ref = addressContainer_get_reloc_flag,
	.is_instance = addressContainer_instance_of,
